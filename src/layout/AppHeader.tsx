            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border border-white/20 bg-white/10 py-2.5 pl-12 pr-14 text-sm text-white shadow-theme-xs placeholder:text-white/50 focus:border-white/40 focus:outline-hidden focus:ring-3 focus:ring-white/10 xl:w-[430px]"
                />

                <button className="absolute right-2.5 top-1/2 inline-flex -translate-y-1/2 items-center gap-0.5 rounded-lg border border-white/20 bg-white/10 px-[7px] py-[4.5px] text-xs -tracking-[0.2px] text-white/70">
                  <span> ⌘ </span>
                  <span> K </span>
                </button>
              </div>
