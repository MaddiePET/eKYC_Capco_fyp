...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] dark:bg-gray-950 text-gray-800 dark:text-white/95 selection:bg-[#F0CA8E] selection:text-[#3D405B]">
          ...
          <div className="flex justify-between items-center h-20">
            ...
            >
              ...
              <Image 
                ...
                />
              <span className={`text-2xl font-bold uppercase tracking-tight transition-colors ${
                isScrolled 
            ...
            >
              <NavigationIcon
                className={`w-7 h-7 transition-transform duration-300 ${
                  ...
                  isScrolled ? "text-[#3D405B] dark:text-white" : "text-white"
                }`}
              />
            </button>
          </div>
      ...
      <section 
        id="section_1" 
        className="relative pt-32 pb-32 lg:pt-36 lg:pb-48 bg-[#3D405B] overflow-hidden text-white transition-colors duration-500"
      >
        <svg 
          className="absolute top-0 left-0 w-full h-24 sm:h-32 md:h-48 lg:h-64 pointer-events-none" 
          preserveAspectRatio="none" 
          xmlns="http://www.w3.org/2000/svg" 
          viewBox="0 0 1440 320"
        >
          <path 
            className="text-white/5 dark:text-black/10" 
            fill="currentColor" 
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="flex flex-col lg:flex-row items-center gap-12">
            <div className="lg:w-1/2 w-full text-center lg:text-left">
              <h1 className="text-4xl lg:text-5xl font-extrabold mb-4 animate-fade-in">
                Welcome to DTCOB
              </h1>
                ...
                <span className="block mt-2 relative h-10 lg:h-12 overflow-hidden w-full">
                  {WORDS.map((word, index) => {
                    ...
                    return (
                      <b 
                        key={word} 
                        className={`absolute top-0 left-0 w-full text-[#F0CA8E] transition-all duration-700 ease-in-out ${
                          positionClass
                        }`}
                      >
                        {word}
              ...
              <div className="flex items-center justify-center lg:justify-start gap-3 mb-6">
                <h3 className="text-lg lg:text-xl font-medium text-white animate-fade-in">
                  No account yet? Register with us now.
                </h3>

                <div className="relative flex items-center group">
                  <svg 
                    className="w-6 h-6 text-[#F0CA8E] hover:text-[#e2bc80] transition-colors" 
                    fill="currentColor" 
                    viewBox="0 0 20 20"
                  >
                    <path 
                  ...
                  <div className="absolute left-1/2 bottom-full mb-3 -translate-x-1/2 z-50 w-72 p-5 rounded-xl shadow-2xl border text-sm opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 bg-white border-gray-100 dark:bg-gray-800 dark:border-gray-700">
                    <div className="absolute left-1/2 top-full -translate-x-1/2 border-[7px] border-transparent border-t-white dark:border-t-gray-800"></div>
                    <p className="text-[#3D405B] dark:text-white font-bold text-base mb-3 border-b pb-2 border-gray-100 dark:border-gray-700">
                      Which account should I create?
                    </p>
                    <p className="mb-3 text-gray-600 dark:text-gray-300 leading-relaxed">
                      <span className="text-[#3D405B] dark:text-white font-bold block">Savings Account</span>
                      Designed for personal banking and everyday spending.
                    </p>
                    <p className="text-gray-600 dark:text-gray-300 leading-relaxed">
                      <span className="text-[#3D405B] dark:text-white font-bold block">Current Account</span>
                      Intended for businesses and companies to manage operations.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-4">
                <Link 
                  href="/savings/user_verification" 
                  className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-bold text-[#3D405B] transition-all rounded-lg bg-[#F0CA8E] shadow-lg hover:bg-[#e2bc80] hover:-translate-y-1 active:scale-95"
                >
                  Savings Account
                </Link>
                <Link 
                  href="/current/user_verification" 
                  className="inline-flex items-center justify-center px-6 py-2.5 text-sm font-bold transition-all bg-transparent border-2 rounded-lg text-[#F0CA8E] border-[#F0CA8E] hover:bg-[#F0CA8E]/10 hover:-translate-y-1 active:scale-95"
                >
                  Current Account
                </Link>
              </div>
        ...
        <svg 
          className="absolute bottom-0 left-0 w-full h-24 sm:h-32 md:h-48 lg:h-64 text-[#F9FAFB] dark:text-gray-950 -mb-1" 
          preserveAspectRatio="none" 
          xmlns="http://www.w3.org/2000/svg" 
          viewBox="0 0 1440 320"
        >
      ...
      <section id="section_2" className="py-24 relative z-10">
        <div className="max-w-5xl mx-auto px-4">
          <h2 className="text-3xl font-extrabold text-center mb-12 text-[#3D405B] dark:text-white">
            Our Core Values
          </h2>
          ...
          <div className="w-full border-2 border-[#81B29A] dark:border-[#81B29A] rounded-3xl overflow-hidden bg-white dark:bg-gray-900/90 shadow-xl dark:ring-4 dark:ring-[#81B29A]/20 transition-all duration-500">
            {CORE_VALUES.map((item, i) => (
              <div 
                key={i} 
                className={`flex flex-col md:flex-row items-center p-8 transition-all duration-300 group hover:bg-gray-50 dark:hover:bg-[#3D405B]/30 ${
                  i !== CORE_VALUES.length - 1 
                    ? "border-b border-[#81B29A]/40 dark:border-[#81B29A]/40" 
                    : ""
                }`}
              >
                <div className="md:w-1/3 flex items-center justify-center md:justify-start gap-4 mb-4 md:mb-0 transition-transform group-hover:translate-x-2">
                  <svg 
                    className="w-10 h-10 text-[#F0CA8E] flex-shrink-0 drop-shadow-sm" 
                    fill="currentColor" 
                    viewBox="0 0 20 20"
                  >
                    {item.icon}
                  </svg>
                  <span className="font-bold text-lg text-[#3D405B] dark:text-white">
                    {item.title}
                  </span>
                </div>
      ...
      <section className="bg-[#3D405B] text-white pt-32 pb-32 lg:pt-40 lg:pb-40 my-12 relative overflow-hidden transition-colors duration-500">
        <svg 
          className="absolute top-0 left-0 w-full h-12 sm:h-16 md:h-24 lg:h-32 pointer-events-none" 
          preserveAspectRatio="none" 
          viewBox="0 0 1440 320"
        >
          <path 
            className="text-[#F0CA8E]/10 dark:text-white/5" 
            fill="currentColor" 
            d="M0,192L48,197.3C96,203,192,213,288,192C384,171,480,117,576,117.3C672,117,768,171,864,192C960,213,1056,203,1152,176C1248,149,1344,107,1392,85.3L1440,64L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z"
          />
          <path 
            className="text-[#F9FAFB] dark:text-gray-950" 
            fill="currentColor" 
        ...
        <svg 
          className="absolute bottom-0 left-0 w-full h-12 sm:h-16 md:h-24 lg:h-32 translate-y-[2px]" 
          preserveAspectRatio="none" 
          viewBox="0 0 1440 320"
        >
          <path 
            className="text-[#F0CA8E]/10 dark:text-white/5" 
            fill="currentColor" 
            d="M0,192L48,186.7C96,181,192,171,288,181.3C384,192,480,224,576,234.7C672,245,768,235,864,213.3C960,192,1056,160,1152,149.3C1248,139,1344,149,1392,154.7L1440,160L1440,320L0,320Z"
          />
          <path 
            className="text-[#F9FAFB] dark:text-gray-950" 
            fill="currentColor" 
          ...
          <div className="flex flex-col md:flex-row gap-8 justify-center">
            {[0, 1].map((offset) => {
              ...
              return (
                <div 
                  key={index} 
                  className={`flex-1 bg-white dark:bg-gray-900/90 rounded-3xl p-10 shadow-xl border border-[#F0CA8E] dark:border-[#F0CA8E] dark:ring-4 dark:ring-[#F0CA8E]/20 flex flex-col items-center justify-center min-h-[320px] transition-all duration-700 ease-in-out ${
                    fadeClass
                  }`}
                >
                  <div className="relative w-20 h-20 mx-auto mb-6 rounded-full ring-4 ring-[#81B29A]/30 overflow-hidden shadow-md group-hover:scale-110 transition-transform">
                    <Image 
                      ...
                      fill sizes="(max-width: 768px) 80px, 80px" 
                      className="object-cover" 
                    />
                  </div>

                  <h5 className="text-lg font-bold text-[#81B29A] mb-2">
                    {testimonial.name}
                  </h5>
                  ...
                  <p className="text-sm text-center text-[#3D405B]/80 dark:text-gray-300 italic font-medium">
                    "{testimonial.text}"
                  </p>
                </div>
              );
      ...
      <section id="section_4" className="py-24 border-t border-b border-gray-200 dark:border-gray-800/0 relative z-10 bg-white/50 dark:bg-gray-950">
        <div className="max-w-6xl mx-auto px-4">
          <h2 className="text-3xl font-extrabold mb-12 text-center text-[#3D405B] dark:text-white">
            ...
            {COMPLIANCES.map((item, i) => (
              <div key={i} className={`flex flex-col md:flex-row bg-white dark:bg-gray-900/90 rounded-2xl p-6 md:p-8 shadow-lg items-center gap-6 md:gap-8 border border-gray-100 dark:border-[#5c6185] hover:border-[#81B29A] dark:hover:border-[#81B29A] dark:hover:ring-4 dark:hover:ring-[#81B29A]/40 hover:scale-[1.01] transition-all duration-300 ${i === 1 ? "md:flex-row-reverse" : ""}`}>
                ...
                <div className="w-full flex-1">
                  <h3 className="text-xl font-bold text-[#3D405B] dark:text-white mb-3">
                    {item.title}
                  </h3>
                  ...
                  <div className="flex flex-col sm:flex-row items-center justify-between border-t border-gray-100 dark:border-[#5c6185]/50 pt-6 gap-4">
                    ...
                    <a
                      ...
                      className="px-6 py-2.5 text-sm font-bold transition-all bg-[#3D405B] rounded-lg text-white hover:bg-[#2c2e42] active:scale-95 text-center sm:text-left"
                    >
                      Learn More
                    </a>
                  </div>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="flex flex-col lg:flex-row gap-16">
            <div className="lg:w-1/2">
              <h2 className="text-3xl font-extrabold mb-8 text-[#3D405B] dark:text-white">
                Contact DTCOB
              </h2>
              <form 
                className="space-y-6" 
              ...
              <div className="bg-white dark:bg-gray-900/90 p-10 rounded-3xl shadow-xl border border-gray-100 dark:border-[#5c6185] dark:ring-4 dark:ring-[#3D405B]/40 mb-8 relative z-10 text-center sm:text-left">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-300 mb-3 flex items-center justify-center sm:justify-start gap-2">
                  ...
                  <a 
                    ...
                    className="hover:text-[#F0CA8E] font-medium transition-colors"
                  >
                    (60) 123456789
                  </a>
                </p>
                <p className="text-sm text-gray-600 dark:text-gray-300 flex items-center justify-center sm:justify-start gap-2">
                  ...
                  <a 
                    href="mailto:dtcobank@gmail.com" 
                    className="hover:text-[#F0CA8E] font-medium transition-colors"
                    >dtcobank@gmail.com
                  </a>
                </p>
      ...
      <footer className="bg-[#F0CA8E] text-white pt-16 pb-8 relative mt-16 transition-colors duration-500">
        <svg 
          className="absolute bottom-full left-0 w-full h-10 md:h-16 lg:h-20 text-[#F0CA8E] -mb-1" 
          preserveAspectRatio="none" 
          viewBox="0 0 1440 320"
        >
          <path 
