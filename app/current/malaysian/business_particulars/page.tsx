...
export default function CurrentMalaysianBusinessParticulars() {
  ...
  const handleFinalSubmit = () => {
    ...
    router.push(`/current/malaysian/business_address?id_type=${encodeURIComponent(idType)}&id_num=${encodeURIComponent(idNum)}&journeyId=${encodeURIComponent(journeyId)}`);
  };
