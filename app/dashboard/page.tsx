...
export default function Dashboard() {
  ...
  const recentOrders = [
    { id: 1, product: "MacBook Pro", price: "RM 2,399", status: "Completed" },
    { id: 2, product: "iPhone 15 Pro", price: "RM 999", status: "Pending" },
    { id: 3, product: "Apple Watch", price: "RM 399", status: "Canceled" },
    { id: 4, product: "Magic Keyboard", price: "RM 159", status: "Completed" },
  ];
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="relative inline-block">
              ...
              <Dropdown 
                ...
                onClose={() => setIsSalesDropdownOpen(false)} 
                className="w-40 p-2"
              >
                <DropdownItem 
                  onItemClick={() => setIsSalesDropdownOpen(false)} 
        ...
        <div className="rounded-2xl border border-gray-200 bg-gray-100 dark:border-gray-800 dark:bg-white/3">
          <div className="px-5 pt-5 bg-white shadow-default rounded-2xl pb-11 dark:bg-gray-900 sm:px-6 sm:pt-6">
            <div className="flex justify-between">
              ...
              <div className="relative inline-block">
                ...
                >
                  <DropdownItem 
                    tag="a" 
                    onItemClick={() => setIsTargetDropdownOpen(false)} 
                    className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                  >
                    View More
                  </DropdownItem>
            ...
            <p className="mx-auto mt-10 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
              You spent RM 3287 this month, it&apos;s lower than last month. Keep up your good work!
            </p>
          </div>
          ...
          <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
            <div className="w-full">
              ...
              <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                Expenses you&apos;ve spent for each month
              </p>
            </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-5 dark:border-gray-800 dark:bg-white/3 sm:p-6">
          <div className="flex justify-between">
            <div>
              ...
              <p className="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
                Number of transactions based on country
              </p>
            </div>
            ...
            <div className="relative inline-block">
              ...
              <Dropdown 
                ...
                onClose={() => setIsDemoDropdownOpen(false)} 
                className="w-40 p-2"
              >
                <DropdownItem 
                  onItemClick={() => setIsDemoDropdownOpen(false)} 
                  className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                >
                  View More
                </DropdownItem>
        ...
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/3">
          <div className="flex items-center justify-between px-4 py-4 sm:px-6">
            ...
            <div className="relative inline-block">
              ...
              >
                <DropdownItem 
                  onItemClick={() => setIsOrdersDropdownOpen(false)} 
                  className="flex w-full font-normal text-left text-gray-500 rounded-lg hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                >
                  View More
                </DropdownItem>
