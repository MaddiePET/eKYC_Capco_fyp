...
function BusinessMalaysianMobileFaceCapture() {
  ...
  const handleCapture = async (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    // Retrieve MyKad image captured locally during the MyKad Capture step
    ...
    try {
      ...
      // Call verification API to compare the Face and ID Card images
        ...
        {success ? (
          <div className="flex flex-col items-center w-full max-w-md animate-in fade-in zoom-in duration-500">
            ...
            <div className="mb-6 text-center">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">Your face has been securely matched with your MyKad.</p>
            </div>
          ...
          <div className="flex flex-col items-center w-full max-w-md animate-in fade-in zoom-in duration-500">
            <div className="mb-6 text-center">
              <h1 className="mb-3 font-bold text-gray-800 text-title-sm dark:text-white sm:text-title-md">Verify Your Face</h1>
              <p className="text-sm text-gray-500 dark:text-gray-400">Please position your face clearly in the frame.</p>
            </div>
