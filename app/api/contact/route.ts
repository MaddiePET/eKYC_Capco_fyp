          ...
          <div style="background-color:#ffffff; border-radius:18px; overflow:hidden; border:1px solid #d9dce8;">
            ...
            <div style="padding:36px 32px 32px;">
              ...
              <p style="margin:0 auto 24px; max-width:420px; color:#374151; font-size:14px; line-height:1.7; text-align:center;">
                You have received a new contact submission from the website.
              </p>

              <!-- Sender Info Box -->
              <div style="text-align:center; margin:24px 0;">
                <div style="display:inline-block; background-color:#eef2ff; border:2px solid #3D405B; color:#2c2f42; padding:18px 24px; border-radius:14px; text-align:left; min-width:280px;">
                  <p style="margin:0 0 8px; color:#4b5563; font-size:12px; font-weight:700; letter-spacing:0.4px; text-transform:uppercase;">
                    Sender Information
                  </p>
                  <p style="margin:0; color:#2c2f42; font-size:14px; font-weight:800;">
                    Name: <span style="font-weight:normal; color:#4b5563;">${username}</span>
                  </p>
                  <p style="margin:6px 0 0; color:#2c2f42; font-size:14px; font-weight:800;">
              ...
              <div style="margin-top:28px;">
                <p style="margin:0 0 8px; color:#2c2f42; font-size:13px; font-weight:700; letter-spacing:0.4px; text-transform:uppercase;">
                  Message Content:
                </p>
